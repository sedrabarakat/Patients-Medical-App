...
abstract class AppLocalizations {
  ...
  /// No description provided for @maritalStatusHint.
  ///
  /// In en, this message translates to:
  /// **'select material state'**
  String get maritalStatusHint;
  ...
  /// No description provided for @iHaveDiabetes.
  ///
  /// In en, this message translates to:
  /// **'I have Diabetes'**
  String get iHaveDiabetes;

  /// No description provided for @iHaveBloodPressure.
  ///
  /// In en, this message translates to:
  /// **'I have Blood-Pressure'**
  String get iHaveBloodPressure;
  ...
  /// No description provided for @chooseSpecialization.
  ///
  /// In en, this message translates to:
